...
document.addEventListener("click", (e)=>{
    ...
    if (leftPos < 0) spider.style.left = 0;
    if (topPos < 0) spider.style.top = 0;
    if (leftPos + spider.clientWidth / 2 > wall.clientWidth) spider.style.left = wall.clientWidth - spider.clientWidth + "px";
    if (topPos + spider.clientHeight / 2 > wall.clientHeight) spider.style.top = wall.clientHeight - spider.clientHeight + "px";
});
